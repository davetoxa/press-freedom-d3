d3.slider = function module() {
    ...
    function slider(selection) {
        selection.each(function() {
            ...
            width = parseInt(div.attr("width"), 10)-(margin.left
                                                    + margin.right);
    ...
    slider.click = function() {
        var abs_pos = this.getBoundingClientRect().left - 20;
        // var pos = d3.event.offsetX - abs_pos || d3.event.layerX - abs_pos;
        var pos = d3.event.offsetX - abs_pos;
        slider.move(pos);
    }
